...
export default () =>
  <div className={styles.aboutSectionWrapper}>
    ...
    <section className={styles.aboutSection}>
      ...
      <p>I have a huge passion for using tech to improve our world and our lives. On top of coding, music is always a huge part of my life too. As a developer, I love getting involved with projects that touch on these areas as much as possible, however I find inspiration in many different areas, so please do let me know what you&apos;re wanting to build.</p>
      <Footer />
    </section>
  </div>;
